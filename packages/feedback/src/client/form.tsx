  ...
  if (status === "success") {
    return (
      ...
      >
        ...
        <p className="text-sm font-medium text-tw-text-primary">
          Feedback sent
        </p>
    ...
    <form onSubmit={handleSubmit} data-feedback-form className="space-y-3">
      ...
      {elementContext && (
        <div className="flex items-center gap-2 rounded-md bg-tw-inner px-2.5 py-2 text-xs">
          <svg
            className="h-3.5 w-3.5 shrink-0 text-tw-accent"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
          ...
          {elementContext.selector && (
            <code className="max-w-[160px] truncate font-mono text-tw-text-tertiary">
              {elementContext.selector}
            </code>
          )}
          {sourceLabel && (
            <>
              ...
              <span className="truncate font-mono text-tw-text-tertiary">
                {sourceLabel}
              </span>
            </>
          )}
      ...
      <textarea
        ...
        rows={3}
        className="w-full resize-none rounded-lg border border-tw-border bg-tw-bg px-3 py-2.5 text-sm text-tw-text-primary transition-colors placeholder:text-tw-text-tertiary focus:border-tw-accent focus:outline-none disabled:opacity-50"
      />
      ...
      <div className="flex items-center justify-between pt-1">
        <label className="group flex cursor-pointer items-center gap-2 select-none">
          ...
          <span className="text-xs text-tw-text-muted transition-colors group-hover:text-tw-text-secondary">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={handleClose}
            disabled={status === "sending"}
            className="rounded-lg px-3 py-1.5 text-xs font-medium text-tw-text-muted transition-colors hover:bg-tw-inner hover:text-tw-text-secondary disabled:opacity-50"
          >
            {ui.cancelLabel}
          </button>
          <button
