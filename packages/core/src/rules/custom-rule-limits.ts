...
export function getCustomRuleLimits(planId: string | null | undefined): CustomRuleLimits {
...
export function definitionReferencesEnrichment(definition: CustomRuleDefinition): boolean {
