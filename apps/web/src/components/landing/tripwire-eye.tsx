...
// All four numbers are in outer-viewBox units (216 × 170).
// Derived from the pixel-space layout in TripwireEye at scale = 1:
//   px → outer-viewBox conversion factor: 216 / 595 ≈ 0.36303
// Socket pixel rect:  (159.5, 163.8, 275, 139.5)
// Pupil  pixel rect:  (262,   198.55, 70, 70.85)   (70.85 from 70 × 30.96/30.59)
