 ...
 */
export function rulesWorkspaceTabFromPath(pathname: string, orgHandle: string): RulesWorkspaceTab | null {
...
export function rulesPathForTab(orgHandle: string, tab: RulesWorkspaceTab): string {
	return `/${orgHandle}/rules/${tab}`;
}

export function isRulesCustomPath(pathname: string, orgHandle: string): boolean {
