const ASSETS_BASE = "https://github.githubassets.com/images/modules/profile/achievements";
...
export const BADGE_DEFINITIONS: Record<string, BadgeDefinition> = {
	...
	"mars-2020-contributor": {
		...
		label: "Mars 2020",
		description: "Contributed code to a repository used in the Mars 2020 mission",
		maxTier: 1,
		hasSkinTones: false,
	},
	"arctic-code-vault-contributor": {
		...
		description: "Contributed to repositories archived in the 2020 GitHub Archive Program",
		maxTier: 1,
		hasSkinTones: false,
	},
	...
	"open-sourcerer": {
		...
		description: "Opened pull requests that have been merged in multiple public repositories",
		maxTier: 4,
		hasSkinTones: false,
	},
};
